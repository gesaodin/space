...
function RegistarTxt(id, tipo){
    ...
    urlt = sUrl + 'tmp/' + data.a + '/' + data.reti;
      ...
      texto += '<a href="' + urlt + '"  target="top" class="btn btn-app"><span class="badge bg-green">' + data.creti + '</span><i class="fa fa-barcode"></i> Retiro </a>';
	    $("#txtMensaje").html(texto);
